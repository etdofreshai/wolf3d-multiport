...
void PollMouseMove (void)
{
	...
	// SDL3 port: get mouse delta from SDL instead of DOS int 33h
...
//
	if (Paused)
	{
		...
		Paused = false;
		if (MousePresent)
			IN_GetMouseDelta(NULL, NULL);	// SDL3: clear accumulated mouse movement
		return;
	}
...
void PlayLoop (void)
{
	...
	do
	{
		if (virtualreality)
		{
			// SDL3 port: VR helmet reading removed (peek from DOS segment 0x40:0xf0)
